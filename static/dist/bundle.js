...
var App = function (_React$Component) {
	...
	function App() {
		...
		_this.getFullWeight = _this.getFullWeight.bind(_this);
		return _this;
	}

	_createClass(App, [{
		key: 'getInputValue',
		value: function getInputValue(e, property) {
			this.setState(_defineProperty({}, property, e.target.value));
		}
	}, {
		key: 'getFullWeight',
		value: function getFullWeight(weight, percentageOfWater) {
			var initialWeight = weight;
			var waterPercentage = percentageOfWater;
			...
			var newWidth = 100 + newWeight * 1.7;
			this.setState({
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						null,
						_react2.default.createElement('img', { width: this.state.imgWidth })
					),
					_react2.default.createElement(
						'div',
						{ className: 'itemLeft' },
						'\u041D\u0430\u0447\u0430\u043B\u044C\u043D\u044B\u0439 \u0432\u0435\u0441 \u0430\u0440\u0431\u0443\u0437\u0430: ',
					...
					_react2.default.createElement(
						'div',
						{ className: 'itemBottomCentered' },
						'\u041F\u0440\u043E\u0446\u0435\u043D\u0442 \u0432\u043E\u0434\u044B \u043F\u043E\u0441\u043B\u0435 \u0443\u0441\u044B\u0445\u0430\u043D\u0438\u044F: ',
	...
	_createClass(Input, [{
		...
		value: function shouldComponentUpdate(nextProps, nextState) {
			if (this.props.value != nextProps.value) {
				this.props.property === 'initialWeight' ? this.props.getWeight(nextProps.value, this.props.water) : this.props.getWeight(this.props.weight, nextProps.value);
			}
			return true;
		}
	}, {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement('input', {
					...
					onInput: function onInput(e) {
						return _this2.props.getValue(e, _this2.props.property);
					}
				})
			);
		}
